...
from dice.strings import StrDieResult, StrDice
...
def main():
	d = StarWarsDice(AbilityDie(), AbilityDie(), DifficultyDie(), 
					ProficiencyDie(), ProficiencyDie())
	#d = AbilityDie()
	#print(d)
	print(d.roll())
